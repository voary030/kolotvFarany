...
CREATE OR REPLACE FORCE VIEW BONDECOMMANDE_CLIENT_CPL (
    ID, DATY, ETAT, REMARQUE, DESIGNATION, MODEPAIEMENT, MODEPAIEMENTLIB,
    IDCLIENT, IDCLIENTLIB, REFERENCE, IDMAGASINLIB, ECHEANCE, MODEREGLEMENT, ETATLIB
) AS
SELECT
    bc.ID,
    bc.DATY,
